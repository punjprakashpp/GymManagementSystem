...
namespace GymManagementSystem
{
    public partial class DeleteMembers : Form
    {
        ...
        private void DeleteMembers_Load(object sender, EventArgs e)
        {
            ...
            using (SqlConnection newcon = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\Gym.mdf;Integrated Security=True;User Instance=True"))
            {
